...
const filteredSlots = useMemo(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-black shadow-sm border-b border-gray-200">
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-4">
          {/* --- RESPONSIVE UPDATE: Use flex-col and sm:flex-row --- */}
          <div className="flex flex-col sm:flex-row items-center justify-between">
            <Link to="/" className="flex items-center hover:opacity-80 transition-opacity mb-4 sm:mb-0"> 
              <div className="p-2 bg-blue-600 rounded-lg">
                <Car className="w-8 h-8 text-blue-100" />
              </div>
              <div className="ml-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center w-full sm:w-auto space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <Link
                to="/trainees"
                className="w-full sm:w-auto flex items-center justify-center px-4 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-800"
              >
                <Users className="w-4 h-4 mr-2" />
                Manage Trainees
              </Link>
              <button
                onClick={handleLogout}
                className="w-full sm:w-auto flex items-center justify-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700"
              >
                <LogOut className="w-4 h-4 mr-2" />
                Logout
              </button>
          ...
          <Route path="/" element={
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-6">
                ...
                {/* --- 2. RIGHT COLUMN (Calendar) --- */}
                {/* --- RESPONSIVE UPDATE: Re-order calendar to be first on mobile --- */}
